  ...
  return (
    <div className="w-full h-screen flex md:justify-around items-start mt-2">
      ...
      <div className="md:w-[60%] w-full ">
        <h1 className="text-headingColor text-4xl font-semibold mb-3">
          Enter Your Address
        </h1>
        <p className="text-textColor text-sm mb-3">
          The Items will be delivered to the given address and can be changed
        </p>
        <form className="w-full max-w-lg mt-2 border rounded-md p-3">
          ...
          <div className="flex justify-between items-center">
            <div className="w-full px-3 mt-6 mb-3 h-11 rounded-md flex items-center justify-start bg-gray-200 w-[48%]">
              ...
              <label
                htmlFor="cod"
                className="block uppercase tracking-wide text-gray-700 mt-2 ml-6 text-xs font-bold mb-2 w-full"
              >
                Cash on Delivery
              </label>
            </div>
          ...
          <button
            className="w-full mt-2 border rounded-md  py-3 px-4 text-white bg-orange-400"
      ...
      <div className="w-[35%] hidden lg:flex flex-col items-start justify-start p-2 relative top-[2.5rem]">
        ...
        <div className="w-full flex flex-col items-start justify-start">
          {cart.map((item) => (
            <div
              className="w-[80%] flex justify-between items-center border rounded-md p-2 mt-2 h-[5rem]"
              key={item?.id}
            >
              <div className="flex justify-between items-center ">
